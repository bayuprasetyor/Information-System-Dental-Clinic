...
if ($_SESSION['hak_akses'] == 'Dokter') {
    ...
    <html>
        <head>
            <title>Halaman Appointment Pasien</title>
        ...
        <body>
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="-webkit-box-shadow: 0px 0px 10px #888888;">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">DokterGG</a>
                </div>
        ...
        echo $_GET['view'] == 'tampil_pasien_dokter' || $_GET['view'] == 'ubah_pasien_dokter' ? 'class="active"' : '';
    } ?>><a href="?view=tampil_pasien_dokter">Data Appointment &nbsp;
                                <span class="label label-warning" style="border-radius: 50px;"> 
                                    <?php

                                    $hitung_pasien = mysqli_query($konek,"select * from pasien");
                                    echo mysqli_num_rows($hitung_pasien);

                                    ?></span></a>
                        </li>
                        <li <?php if (isset($_GET['view'])) {
                                        echo $_GET['view'] == 'tampil_add_dokter' ? 'class="active"' : '';
                                    } ?>><a href="?view=tampil_add_dokter">Edit Data Diri Anda &nbsp;
                                    </a>
                        </li>  
            ...
            <div class="container">
                ...
                <footer align="center">
                    Created by <a href="">Kelompok RSGG</a>
                </footer>
