    ...
    <html>
        ...
        echo $_GET['view'] == 'tampil_pasien_dokter' || $_GET['view'] == 'ubah_pasien_dokter' ? 'class="active"' : '';
                                ...
                                <span class="label label-warning" style="border-radius: 50px;"> 
                                    <?php
                                    $hitung_pasien = mysqli_query($konek,"select rj.no_rj from tbl_prj rj left join tbl_dokter d on rj.id_dokter = d.id_user where d.nama_dokter='" . $_SESSION['grup'] . "'");
                        ...
                        <li <?php if (isset($_GET['view'])) {
                                ...
                                <span class="label label-info" style="border-radius: 50px;"> 
                                    <?php
                                    $hitung_resep = mysqli_query($konek,"select distinct id_resep from tbl_resep where id_dokter=".$_SESSION['id_user']);
