    ...
    <html>
        ...
        echo $_GET['view'] == 'tampil_pasien' || $_GET['view'] == 'ubah_pasien' ? 'class="active"' : '';
                                ...
                                <span class="label label-warning" style="border-radius: 50px;"> 
                                    <?php
                                    $hitung_pasien = mysqli_query($konek,"SELECT * from tbl_prj where departemen='" . $_SESSION['grup'] . "'");
                        ...
                        <li <?php if (isset($_GET['view'])) {
                                ...
                                <span class="label label-info" style="border-radius: 50px;"> 
                                    <?php
                                    $hitung_pasien = mysqli_query($konek,"SELECT * from tbl_dokter where departemen='" . $_SESSION['grup'] . "'");
                                    echo mysqli_num_rows($hitung_pasien);
                                    ?></span></a>
                        </li>  
