                    ...
                    <ul class="nav navbar-nav">
                        <li <?php if (isset($_GET['view'])) {
                         ...
                         <li <?php if (isset($_GET['view'])) {
                                            ...
                                            } ?>><a href="cs.php?view=tampil_pri">Biaya Pasien &nbsp;
                                            <span class="label label-warning" style="border-radius: 50px;"> 
                            <?php
                                $hitung_pri = mysqli_query($konek,"select * from tbl_pri");
                        ...
                        <li <?php if (isset($_GET['view'])) {
                                ...
                                } ?>><a href="cs.php?view=tampil_dokter">Rekrut Dokter &nbsp;
                                <span class="label label-success" style="border-radius: 50px;"> 
                                    <?php
                                    $hitung_dokter = mysqli_query($konek,"select * from tbl_dokter");
                                    echo mysqli_num_rows($hitung_dokter);
                                    ?></span></a>
                        </li>  
                                    
                                    </ul>
                                    <p class="navbar-text navbar-right"><?php echo $_SESSION['username']; ?> login | <a class="btn btn-default btn-xs" href="logout.php"><i class="glyphicon glyphicon-off"></i> Logout</a>  &nbsp;</p>
                                    </div>
