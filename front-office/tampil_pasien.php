    ...
    if (mysqli_num_rows($result)) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td><?php echo "<a class='btn btn-info btn-sm' href='cs.php?view=tampil_ubah_pasien&id_pasien=" . $row['id_pasien'] . "'><i class='glyphicon glyphicon-edit'></i></a> | 
                    <a class='btn btn-danger btn-sm' href='cs.php?view=aksi_hapus_pasien&id_pasien=" . $row['id_pasien'] . "' onclick='return confirm(&quot;Apakah anda yakin akan menghapus data pasien tersebut?&quot;)'><i class='glyphicon glyphicon-trash'></i></a>";
            ?></td>
        </tr>
        <?php
        $no ++;
        ...
        $("button#submit").click(function () {
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    location.href = 'cs.php?view=tampil_pasien';
                    ;
                },
                error: function () {
