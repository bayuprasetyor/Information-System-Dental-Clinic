...
if ($_POST) {
    $q = $_POST['search'];
    $sql_res = mysqli_query($konek,"select id_pasien,nama_pasien, alamat from tbl_pasien where id_pasien like '%$q%' or nama_pasien like '%$q%' order by id_pasien LIMIT 5");
