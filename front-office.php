...
if ($_SESSION['hak_akses'] == 'Front Office') {
    ...
    <html>
        ...
        echo $_GET['view'] == 'pesan' || $_GET['view'] == 'tampil_ubah_pasien' ? 'class="active"' : '';
    } ?>><a href="front-office.php?view=pesan">Pasien &nbsp;
                        ...
                        <li <?php if (isset($_GET['view'])) {
                                ...
                                <span class="label label-info" style="border-radius: 50px;"> 
                                    <?php
                                    $hitung_pri = mysqli_query($konek,"select * from tbl_prj");
                                            ...
                                            <div class="panel panel-default"> 
                                                <div class="panel-body">
                                                    ...
                                                    if (isset($_GET['view'])) {
                                                        ...
                                                        header("location:front-office.php?view=pesan");
                                                    }
                                                    ?>
                                                </div>
                                            </div>
